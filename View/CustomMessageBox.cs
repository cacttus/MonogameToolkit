...
namespace Monoedit
{
    public partial class CustomMessageBox : Form
    {
        ...
        public CustomMessageBox(string contents, string caption, MessageBoxButtons button, MessageBoxIcon img, List<string> customButtonOptions = null)
        {
        ...
        public static DialogResult Show(string contents, string caption, MessageBoxButtons button, MessageBoxIcon img,
            List<string> customButtonOptions = null)
        {
