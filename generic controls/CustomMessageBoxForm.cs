...
namespace Monoedit
{
    public partial class CustomMessageBox : MonoEditForm
    {
        ...
        public CustomMessageBox(Phrase contents, Phrase caption, MessageBoxButtons button, MessageBoxIcon img, List<string> customButtonOptions = null)
            : this(Translator.Translate(contents), caption, button, img, customButtonOptions)
        {
        }

        public CustomMessageBox(string contents, Phrase caption, MessageBoxButtons button, MessageBoxIcon img, List<string> customButtonOptions = null)
        {
        ...
        public static DialogResult Show(string contents, Phrase caption, MessageBoxButtons button, MessageBoxIcon img,
    List<string> customButtonOptions = null)
        {
            CustomMessageBox b = new CustomMessageBox(contents, caption, button, img, customButtonOptions);
